...
#include <jni.h>
/* Header for class co_hodlwallet_core_BRCoreTransactionInput */

#ifndef _Included_co_hodlwallet_core_BRCoreTransactionInput
#define _Included_co_hodlwallet_core_BRCoreTransactionInput
#ifdef __cplusplus
extern "C" {
#endif
/*
